...
function App() {
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // En Docker, el backend ahora está expuesto en el puerto 5050
      // Si usamos un proxy o Nginx, la URL podría variar. Por ahora asumimos localhost:5050
      const response = await fetch('http://localhost:5050/api/solicitudes', {
        method: 'POST',
        headers: {
